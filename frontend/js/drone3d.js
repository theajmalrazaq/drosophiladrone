...
class Drone3DVisualizer {
    ...
    setupDroneEntity() {
        ...
        const createPropNodeTransform = (propIdx) => {
            return new Cesium.NodeTransformationProperty({
                ...
                scale: new Cesium.ConstantProperty(new Cesium.Cartesian3(1.0, 1.0, 1.0))
            });
        };
    ...
    updateTelemetry(data) {
        ...
        // Apply -90 deg (-pi/2) heading correction so green arrow faces exactly along velocity vector
